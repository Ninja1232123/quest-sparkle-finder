...
// The "pages" child of the sitemap index: hand-curated landing/static pages plus
// every codebook landing, per-source browser, and topic page. The actual
// document corpus is enumerated separately in /sitemap-docs.xml (one child per
// source/page) so this file stays small and the per-document query stays paged.
    ...
    handlers: {
      GET: async () => {
        const staticPaths: SitemapEntry[] = [
          ...
          { path: "/outcomes", changefreq: "weekly", priority: "0.9" },
